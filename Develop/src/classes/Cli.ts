  ...
  findVehicleToTow(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        this.performActions();
        // TODO: check if the selected vehicle is the truck -donezo
        // TODO: if it is, log that the truck cannot tow itself then perform actions on the truck to allow the user to select another action-donezo
        // TODO: if it is not, tow the selected vehicle then perform actions on the truck to allow the user to select another action-donezo
      })
  }
